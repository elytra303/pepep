...
//        }
            ...
            if (mode.isSelected("Slime Block")) {
                ...
                if (script.isFinished() && (offHand || slotId != -1) && !blockPos.equals(BlockPos.ORIGIN)) {
                    ...
                    if (canPlace(stack)) {
                        ...
                        if (!offHand) mc.player.getInventory().setSelectedSlot(slotId);
                        ...
                        if (!offHand) mc.player.getInventory().setSelectedSlot(prev);
                    }
                }
            }
        }
    ...
    private BlockPos getPlaceableWaterBlock() {
        BlockPos below = BlockPos.ofFloored(mc.player.getEntityPos().add(0, -1.3, 0));
